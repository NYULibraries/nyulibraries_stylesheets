module NyulibrariesStylesheets
  class Engine < ::Rails::Engine
    ...
    initializer "config.assets.precompile" do |app|
      ...
      # puts "ADDING: #{Dir['app/assets/stylesheets/nyulibraries_stylesheets/*.scss']}"
      # app.config.assets.precompile += Dir['app/assets/stylesheets/nyulibraries_stylesheets/*.scss']
      # app.config.assets.precompile += Dir['app/assets/stylesheets/nyulibraries_stylesheets/**/*.scss']
      # app.config.assets.precompile += Dir['app/assets/stylesheets/nyulibraries_stylesheets/**/**/*.scss']
    end
  end
